...
void loop() {
  ...
  if (values.value_y > leftValue && values.value_y < rightValue) {
    turnValue = 1.0;
  }
  ...
  if ((!front && !back || front && back) && values.value_y > leftValue && values.value_y < rightValue) {
    //speedValue = 0;
    digitalWrite(MOTOR1_pos, LOW);
    digitalWrite(MOTOR2_pos, LOW);
    digitalWrite(MOTOR3_pos, LOW);
  ...
  if (!front && !back && values.value_y < leftValue) {
    digitalWrite(MOTOR1_pos, LOW);
    digitalWrite(MOTOR2_pos, LOW);
    digitalWrite(MOTOR3_pos, LOW);
    digitalWrite(MOTOR4_pos, LOW);
  ...
  if (!front && !back && values.value_y > rightValue) {
    digitalWrite(MOTOR1_pos, LOW);
    digitalWrite(MOTOR2_pos, LOW);
    digitalWrite(MOTOR3_pos, LOW);
    digitalWrite(MOTOR4_pos, LOW);
